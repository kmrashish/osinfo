...
<center> <p id="whatru" style="margin-top:0px"> About Ubuntu </p> <img src="ubuntu_logo.png" /> </center><br><hr color="#999999">

<div id="biggest" style="width:100%; margin-left:20px;">		
		<p><strong>Ubuntu</strong> is a Debian-based Linux operating system, with Unity as its default desktop environment. It is based on free software and named after the Southern African philosophy of ubuntu (literally, "human-ness"), which often is translated as "humanity towards others" or "the belief in a universal bond of sharing that connects all humanity".</p>

<p>According to some metrics, Ubuntu is the most popular Linux distribution.</p><p>
